...
VALUES
    ('Prinses Irenestraat', '12', 1, NULL, SYSDATE(), SYSDATE()),
...
INSERT INTO `klant` (`Naam`, `Vertegenwoordiger`, `Achternaam`, `AdresId`, `KlantContactId`, `Volwassenen`, `Kinderen`, `Babies`, `Wens`, `IsActief`, `Opmerking`, `DatumAangemaakt`, `DatumGewijzigd`)
VALUES
